...
import { BookOpen, Users, DollarSign, TrendingUp, Menu } from "lucide-react";
    ...
    <div className="flex min-h-[100dvh]">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-4 md:p-8 flex-1">
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl mb-2">لوحة تحكم المدير</h1>
            <p className="text-muted-foreground text-base md:text-lg">نظرة عامة على المنصة</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <DosyaCard>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <button className="p-4 bg-primary/10 rounded-xl hover:bg-primary/20 transition-all text-right h-full">
