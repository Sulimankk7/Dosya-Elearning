...
import { User, Camera, BookOpen } from "lucide-react";
    ...
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl mb-2">الملف الشخصي</h1>
            <p className="text-muted-foreground text-lg">إدارة معلوماتك الشخصية</p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <DosyaCard>
                ...
                <div className="space-y-4">
                  ...
                  />
                  <DosyaButton onClick={handleChangePassword}>
                    تغيير كلمة المرور
                  </DosyaButton>
                </div>
              </DosyaCard>
