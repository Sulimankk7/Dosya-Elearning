...
import { Plus, Edit, Trash2, GripVertical, X, Upload, ImageIcon, Menu } from "lucide-react";
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-4 md:p-8 flex-1">
          <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-3xl md:text-4xl mb-2">إدارة الكورسات</h1>
              <p className="text-muted-foreground text-base md:text-lg">عرض وتحرير الكورسات المتاحة</p>
            </div>
            <DosyaButton className="w-full sm:w-auto min-h-[44px]" onClick={openAddModal}>
          ...
          <div className="overflow-x-auto pb-4 -mx-4 px-4 md:mx-0 md:px-0">
            <DosyaCard className="min-w-[800px]">
              ...
              <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-6">
                <DosyaCard className="max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    <DosyaButton className="flex-1 min-h-[44px]" onClick={handleAddCourse}>
                      إضافة الكورس
                    </DosyaButton>
                    <DosyaButton variant="outline" className="flex-1 min-h-[44px]" onClick={() => setShowAddModal(false)}>
                      إلغاء
                    </DosyaButton>
                  </div>
                </DosyaCard>
            ...
            {showEditModal && (
              <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-6">
                <DosyaCard className="max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                  ...
                  {renderCourseFormFields()}
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    <DosyaButton className="flex-1 min-h-[44px]" onClick={handleEditCourse}>
                      حفظ التغييرات
                    </DosyaButton>
                    <DosyaButton variant="outline" className="flex-1 min-h-[44px]" onClick={() => setShowEditModal(false)}>
                      إلغاء
                    </DosyaButton>
                  </div>
                </DosyaCard>
